...
class BannerVenda(GridLayout):
    ...
    def __init__(self, **kwargs):       #   passing kwargs as a parameter, we can get all the information we give to the banner in main.py
        self.rows = 1
        super().__init__()       # use all the features of the gridlayout class
        ...
        #Now with all the values ​​defined, we analyze which part of the banner we will place
        ...
        #combine the image with the label
